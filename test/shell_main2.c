 ...
 *  @agv: command line argument (compiled file)
 *  
 *  Return: void
 * /
void run_cmd(char * * cmd, char *agv)
...
#include <stdlib.h> /* Include the standard library header for setenv and unsetenv */
#include <stdio.h>
#include <string.h>
#include <unistd.h>
#include <sys/types.h>
...
/**
 *run_cmd - handle commands including built-in commands
 *@cmd : double pointer to the command line args
 *@agv : command line argument (compiled file)
 *  
 *  Return: void
...
/ *Check for built-in commands like setenv and unsetenv*/
